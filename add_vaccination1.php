...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($rowCount > count(array_unique($_POST["vaccine_type"]))){
        $duplicate = TRUE;
...
<script>
    $(document).ready(function(){
        $(".add-row").click(function(){
            ...
            if (exp_date < date){
                exp_date_err.innerHTML = "<font color='red'>exp date must be later than administered date</font>";
                add_vaccine = false;
            }
...
<!--<table style="background-color:rgba(255, 255, 255, 0.9);">-->
            ...
            <tr>
                ...
                <td><input type="date" id="date" name="date[]" max = "<?php echo date('Y-m-d') ?>" value="<?php
            ...
            <tr>
                ...
                </td><td><label for="Output" name="exp_date_err" id="exp_date_err"></label> </td>
            </tr>
...
<br>
        ...
        <?php
        if ($duplicate) {
            print "<div class='subtitle'>Vaccine is duplicated!</div>";
        }
